...
const GROUPS: Group[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: "What is the interview guarantee?", a: "Actively use JobsAI and if you don't land an interview within 90 days, we refund you. We can offer it because the platform applies at a volume and quality that's hard to match by hand." },
    ],
  },
  {

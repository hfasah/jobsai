...
const BOARDS: Board[] = [
  ...
  { id: "catho",       name: "Catho",           logo: "🟠", reach: "Brazil — leading job board", method: "feed", setupUrl: "https://www.catho.com.br/empresas/", instructions: "Catho is one of Brazil's largest job boards. Create a Catho employer account, then share your XML feed URL with Catho's integration/feed team (or import jobs via their employer portal) so your active roles publish automatically. A Catho employer plan may be required." },

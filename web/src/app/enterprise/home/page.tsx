    ...
    <main className="min-h-screen bg-background text-foreground">
      ...
      <section className="mx-auto max-w-4xl px-6 pb-20">
        <div className="rounded-2xl border border-primary/30 bg-gradient-to-r from-primary/10 to-transparent p-8 text-center">
          ...
          <h2 className="mt-3 text-2xl font-bold">Limited-Time Offer — 50% off for life</h2>
          <p className="mt-2 text-sm text-muted-foreground">Lock in 50% off any plan, for life. Limited-time launch pricing — ending soon.</p>

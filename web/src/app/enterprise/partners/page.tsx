...
import { ArrowRight, Handshake, Check, Sparkles, TrendingUp, Crown, Star, Link2, BarChart3, Megaphone, Headphones, Users, Rocket } from "lucide-react";
...
export const metadata = {
  ...
  description: `Refer recruiting agencies, staffing firms, and HR teams to JobsAI Enterprise and earn ${PARTNER_BASE_RATE}–30% recurring commission for ${PARTNER_COMMISSION_MONTHS} months.`,
};

const APPLY = "/enterprise/contact?topic=partner";
const BENEFIT_ICONS = [TrendingUp, BarChart3, Link2, Megaphone, Headphones, Users, Rocket];
  ...
  return (
    <main className="min-h-screen bg-background text-foreground">
      ...
      <section className="border-b border-border bg-gradient-to-b from-primary/5 to-transparent px-6 py-16 text-center">
        ...
        <h1 className="mx-auto mt-2 max-w-2xl text-3xl font-bold tracking-tight sm:text-4xl">Turn your network into recurring revenue</h1>
        <p className="mx-auto mt-3 max-w-2xl text-muted-foreground">
          Refer recruiting agencies, staffing firms, HR departments, and talent acquisition teams to JobsAI Enterprise — and earn {PARTNER_BASE_RATE}–30% recurring commission for {PARTNER_COMMISSION_MONTHS} months on every customer.
        </p>
      ...
      <section id="how-it-works" className="border-y border-border bg-muted/20 px-6 py-14 scroll-mt-16">
        <div className="mx-auto max-w-4xl">
          ...
          <p className="mb-8 text-center text-sm text-muted-foreground">Earn a percentage of what your referred customers actually pay — every month, for a year.</p>

...

{
  ...
  "explanation": "2-3 sentences written directly TO the candidate using 'you'/'your'. Lead with their single strongest asset for THIS specific role — name it concretely. Tell them honestly where they stand and why a hiring manager would want to meet them. End with something a great coach would actually say to fire them up — specific to their situation, not a generic slogan.",
  "coach_note": "2-3 sentences of deep coaching belief. This is your moment to make them feel capable and ready. Remind them that great hires are rarely a perfect keyword match — they are the person who showed up most prepared, most confident, and most genuine. Acknowledge the work they've already put in (building a strong résumé, applying, putting themselves out there). Tell them the job search is hard for everyone and the ones who win are the ones who keep going. Push them — not with empty words but with truth: their background is real, their experience is real, and the right company will see that. If they land this interview, they should know they belong in that room.",
  "interview_tip": "The single sharpest thing they should lead with or be ready to own in depth — specific to their actual background and this exact role. Frame it as what will make the hiring manager lean forward.",
  "breakdown": {
    "skills": 0-100,
    "experience": 0-100,
    "title": 0-100,

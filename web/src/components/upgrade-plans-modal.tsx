...
const PLANS: PlanCard[] = [
  {
    ...
    features: ["5,000 tokens / month", "Auto-apply + résumé tools", "Unlimited AI Written Coach", "Unlimited résumés & job imports"],
  },
  {
    plan: "premium", label: "Premium", tagline: "Most chosen by interviewees", price: 79, popular: true, icon: Mic,
    features: ["20,000 tokens / month", "Everything in Pro", "AI Voice Interviewer + analysis", "AI Avatar Room access"],
  },
  {
    plan: "accelerator", label: "Career Accelerator", tagline: "Maximum realism + coaching", price: 199, icon: Rocket,
    features: ["60,000 tokens / month", "Everything in Premium", "More avatar interview minutes", "Interview recordings & replay"],
  },
];

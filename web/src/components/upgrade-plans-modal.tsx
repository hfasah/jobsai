...
const PLANS: PlanCard[] = [
  {
    ...
    features: ["5,000 tokens / month", "Auto-apply up to 30 jobs/day", "Unlimited AI Written Coach", "Unlimited résumés & job imports"],
  },
  {
    plan: "premium", label: "Premium", tagline: "Most chosen by interviewees", price: 79, popular: true, icon: Mic,
    features: ["20,000 tokens / month", "Auto-apply up to 100 jobs/day", "AI Voice Interviewer + analysis", "AI Avatar Room access"],
  },
  {
    plan: "accelerator", label: "Career Accelerator", tagline: "Maximum realism + coaching", price: 199, icon: Rocket,
    features: ["60,000 tokens / month", "Auto-apply up to 300 jobs/day", "1 free coaching session/mo", "Interview recordings & replay"],
  },
];

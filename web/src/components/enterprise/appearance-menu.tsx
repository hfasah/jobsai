...
// Appearance switcher (Light / Dark / System) backed by next-themes. Designed
// for the enterprise workspace sidebar footer; the menu opens upward. The
// workspace pages use bg-background/text-foreground (no forced dark), so they
...
export function AppearanceMenu() {
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {open && (
        <div className="absolute bottom-full left-0 z-50 mb-1 w-full overflow-hidden rounded-lg border border-border bg-card p-1 shadow-xl">

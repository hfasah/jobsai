  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="mx-auto max-w-4xl px-6 pt-16 pb-10 text-center">
        ...
        <h1 className="text-3xl font-bold sm:text-4xl">{item.headline}</h1>
      ...
      <section className="border-t border-border bg-muted/30">
        <div className="mx-auto max-w-5xl px-6 py-12">
          <h2 className="mb-5 text-sm font-semibold uppercase tracking-wider text-muted-foreground">{othersLabel}</h2>
      ...
      <section className="mx-auto max-w-3xl px-6 py-16 text-center">
        <h2 className="text-2xl font-bold">See JobsAI Enterprise for {item.name.toLowerCase()}</h2>

...
const securityHeaders = [
  ...
  // 'unsafe-eval' is needed for Clerk's hosted JS.
  {
    ...
    value: [
      "default-src 'self'",
      "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://*.clerk.com https://*.clerk.accounts.dev https://js.stripe.com https://api.leadconnectorhq.com",
      ...
      "frame-src https://*.clerk.com https://js.stripe.com https://hooks.stripe.com https://api.leadconnectorhq.com",
      "media-src 'self' blob:",
      "worker-src blob:",
    ].join("; "),
  },

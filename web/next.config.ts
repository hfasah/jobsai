...
const securityHeaders = [
  ...
  // 'unsafe-eval' is needed for Clerk's hosted JS.
  {
    ...
    value: [
      "default-src 'self'",
      "script-src 'self' 'unsafe-inline' 'unsafe-eval' blob: https://*.clerk.com https://*.clerk.accounts.dev https://js.stripe.com https://api.leadconnectorhq.com",
      ...
      "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://*.clerk.com https://*.clerk.accounts.dev https://api.clerk.dev https://api.skyvern.com https://api.resend.com https://api.stripe.com",
      "frame-src blob: https://*.clerk.com https://js.stripe.com https://hooks.stripe.com https://api.leadconnectorhq.com",
      "media-src 'self' blob:",
      "worker-src blob:",
    ].join("; "),
  },
